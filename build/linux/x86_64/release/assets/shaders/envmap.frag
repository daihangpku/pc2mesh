...
void main() {
    ...
    // your code here
    vec3 reflectionDir = reflect(-viewDir, normal); // 计算反射向量
    vec3 envColor = texture(u_EnvironmentMap, reflectionDir).rgb; // 采样环境贴图
    total += envColor * u_EnvironmentScale; // 加入环境贴图贡献
